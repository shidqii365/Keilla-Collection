...
<body class="bodydetail">
  ...
  <!-- Container About -->
  <div class="container halamanedit">
    <div class="row justify-content-md-center">
      <div class="col-md-6">
        <div class="card bg-light my-5">
          <div class="card-header text-center">Edit Produk</div>
          <div class="card-body">
            <form action="../koneksi/editdata.php" method="post" class="needs-validation" novalidate>
              ...
              <div class="text-center">
                <button type="submit" class="btn btn-primary text-center px-3 py-2" name="submit">Konfirmasi Edit</button>
              </div>
            </form>
          </div>
        </div>

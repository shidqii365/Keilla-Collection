<nav class="navbar navbar-expand-lg navbar-light">
  <div class="container">
    <a class="navbar-brand" href="home.php"><img src="" alt="">Keilla Collection</a>
    ...
    <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
      <div class="navbar-nav ml-auto">
        ...
        <?php
          ...
          <a class="nav-link" href="tabel_produk.php">Produk</a>
          <a class="nav-link" href="tabel_pelanggan.php">Pelanggan</a>
          <a class="nav-link" href="tabel_pesanan.php">Pesanan</a>
